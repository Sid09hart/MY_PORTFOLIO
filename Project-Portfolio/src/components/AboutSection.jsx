      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-12 items-center'>
        ...
        <div className='flex flex-col sm:flex-row gap-4 pt-4 justify-center'>
          <a href="#contact" className='cosmic-button'>
           ...
           <a href="https://drive.google.com/file/d/1kSJj7dsOTApEJCsV5oZAMNtuzEo_dhJG/view?usp=drive_link" className='px-6 py-2 rounded-full border border-primary text-primary hover:bg-primary/10 transition-colors duration-300' target='__blank'>
            {" "}
            Download CV
          </a>
